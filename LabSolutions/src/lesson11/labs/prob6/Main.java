...
public class Main {
	...
	public static boolean contains3(List<? extends Employee> list, Employee e, BiPredicate<Employee,Employee> pred2)
	{
	...
	public static <T>  boolean contains4(List<? extends T> list, T e, BiPredicate<? super T,? super T> pred2)
	{
		for(T emp: list) {
			if(emp == null && e == null) return true;
			if(emp == null || e == null) continue;
	...
	public static void test2() {
		...
		boolean foundIt = Main.contains4(list, e, (e1,e2) -> e1.getId()==e2.getId());
	...
	public static void test3() {
		...
		boolean foundIt = Main.contains4(list, m, (Employee e1, Employee e2) -> e1.getId()==e2.getId());
		System.out.println(foundIt);
	}
