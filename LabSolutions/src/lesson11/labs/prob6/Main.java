...
public class Main {
	...
	public static <T extends Person> boolean contains4(List<? extends Employee> list, T e, BiPredicate<Employee,T> pred2) 
	{
		for(Employee emp: list) {
			if(emp == null && e == null) return true;
			if(emp == null || e == null) continue;
	...
	public static <T extends Account> boolean contains5(List<? extends Account> list, T e, BiPredicate<Account,Account> pred2) 
	{
